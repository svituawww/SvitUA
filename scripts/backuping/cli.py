...
Examples:
  ...
  python cli.py --config backup_config.yaml --backup

  # Create backup with custom commit message
  python cli.py --config backup_config.yaml --backup --message "Updated website design"

  # Verify specific backup
  python cli.py --config backup_config.yaml --verify 2025-01-15_14-30-25_a1b2c3d

  # List all backups
  python cli.py --config backup_config.yaml --list

  # Restore from backup
  python cli.py --config backup_config.yaml --restore 2025-01-15_14-30-25_a1b2c3d --restore-path ./restored

  # Cleanup old backups
  python cli.py --config backup_config.yaml --cleanup --max-backups 5
        """
    )
